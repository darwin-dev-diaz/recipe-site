...
function RecipeScreen() {
  ...
  return (
    <div>
      {/* top section start */}
      <div className="section mx-auto max-w-[46rem] px-6">
        ...
        <div>
          ...
          {calendarOpen ? (
            <div className="">
              <div className="calendar h-fit w-full bg-very-light-grey lg:flex">
                <ScrollableCalendar
                ...
                <div className="h-full">
                  <div className="z-40 mx-auto mb-8 flex h-12 w-full max-w-96 items-center bg-orange lg:mt-4 lg:w-fit lg:px-2">
                    <h2 className="text-stroke-black text-stroke-2 stroke-text smooth-16 relative mx-auto w-fit pl-3 text-3xl font-extrabold uppercase text-white lg:pl-0 lg:text-lg">
                      {`meal plan`}
                    </h2>
                  </div>
      ...
      <div className="flex w-full justify-center bg-very-dark-orange">
        <div
          // id="recipe"
          className="section md:pt-30 relative flex h-80 w-full max-w-[46rem] flex-col items-center gap-3 bg-very-dark-orange bg-cover bg-center px-6 pt-20 font-medium uppercase text-white lg:h-96 lg:pt-32"
        >
          <div
            id="recipe"
            className="absolute left-[50%] top-0 h-32 w-32 translate-x-[-50%] translate-y-[-50%] rounded-full border-[6px] border-very-dark-orange bg-dark-orange bg-cover bg-center md:h-36 md:w-36 lg:h-48 lg:w-48"
            style={{ backgroundImage: `url(${idToImage(recipeID)})` }}
          ></div>
      ...
      <div className="flex justify-center">
        <div className="section max-w-[46rem] px-6">
          <Button
            width="w-full"
            height="h-[50px]"
            color={isFavorite ? "black" : "white"}
          ...
          {/* ingredients start */}
          <h3 className="mb-9 text-2xl font-extrabold uppercase">
            Ingredients
          </h3>
